...
<div class="container-fluid">
	...
	<p>Schedule: <b><large><?php echo ucwords($schedule) ?></large></b></p>
	<hr class="divider">
	<?php echo html_entity_decode($content) ?>
    <div class="col-md-5">
							<img height="150px" width="800px" src="<?php echo isset($banner) ? 'assets/uploads/'.$banner :'' ?>" alt="" id="banner-field">
						</div>
</div>
